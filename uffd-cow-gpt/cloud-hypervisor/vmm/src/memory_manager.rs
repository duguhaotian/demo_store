...
use crate::{GuestMemoryMmap, GuestRegionMmap, MEMORY_MANAGER_SNAPSHOT_ID, template_memory, uffd};
...
impl MemoryManager {
    ...
    fn restore_by_uffd(
        ...
        let mut handler_ranges: Vec<template_memory::TemplateRange> = Vec::new();
        ...
        for range in saved_regions.regions() {
            ...
            handler_ranges.push(template_memory::TemplateRange::new(
                host_addr,
                range.length,
                file_offset,
                range_page_size,
